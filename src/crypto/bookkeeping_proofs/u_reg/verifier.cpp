    ...
    namespace u_reg
    {
        ...
        bool verify(CRS const &crs, GS_Proof const &proof, GS_Input_Public const &input)
        {
            ...
            auto lhs_e60 = pool.push([&](int) -> auto
                                     { return commitments.zkPKbranch1 * BN(1) * commitments.g2 + commitments.g1branch1 * BN(1) * commitments.zkHash + commitments.g1branch1 * BN(-1) * commitments.zkSig; });
            auto lhs_e70 = pool.push([&](int) -> auto
                                     { return commitments.g1 * BN(-1) * commitments.branch1 + commitments.g1 * BN(-1) * commitments.branch0 + commitments.g1 * BN(1) * commitments.g2; });
            ...
            auto lhs_e90 = pool.push([&](int) -> auto
                                     { return commitments.g1 * BN(-1) * commitments.branch1 + commitments.g1branch1 * BN(1) * commitments.branch1; });
            auto lhs_e91 = pool.push([&](int) -> auto
                                     { return commitments.zkPK * BN(-1) * commitments.branch1 + commitments.zkPKbranch1 * BN(1) * commitments.branch1; });
            ...
            return res_e90 && res_e80 && res_e60 && res_e70 && res_e01 && res_e91;
        }
        ...
        bool batch_verify(CRS const &crs, GS_Proof const &proof, GS_Input_Public const &input)
        {
            ...
            auto lhs_e70 = pool.push([&](int) -> auto
                                     { return batched_c_g1 * BN(-1) * batched_c_branch1 + batched_c_g1 * BN(-1) * batched_c_branch0 + batched_c_g1 * BN(1) * batched_c_g2; });
            auto lhs_e80 = pool.push([&](int) -> auto
            ...
            auto lhs_e60 = pool.push([&](int) -> auto
                                     { return batched_c_zkPKbranch1 * BN(1) * batched_c_g2 + batched_c_g1branch1 * BN(1) * batched_c_zkHash + batched_c_g1branch1 * BN(-1) * batched_c_zkSig; });
            auto lhs_e90 = pool.push([&](int) -> auto
                                     { return batched_c_g1 * BN(-1) * batched_c_branch1 + batched_c_g1branch1 * BN(1) * batched_c_branch1; });
            auto lhs_e91 = pool.push([&](int) -> auto
                                     { return batched_c_zkPK * BN(-1) * batched_c_branch1 + batched_c_zkPKbranch1 * BN(1) * batched_c_branch1; });
