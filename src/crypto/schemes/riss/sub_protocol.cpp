...
bool sub_proc::check_if_not_all_shares_received_and_calc_share(int &party_index)
{
  ...
  {
    BilinearGroup::BN my_share = calculate_share(shares[party_index], y_values_p, BilinearGroup::BN::get_group_order());
    my_share = r_values[party_index] - my_share;
