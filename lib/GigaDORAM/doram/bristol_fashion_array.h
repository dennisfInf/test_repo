                     ...
                     Circ_exec *rep_exec)
        {
            ...
            else
            {
                ...
                if (chunk * 1024 != num_parallel)
                {
                    ...
                    {
                    case 1:
                        compute_internal<Circ_exec, block, 1>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 2:
                        compute_internal<Circ_exec, block, 2>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 3:
                        compute_internal<Circ_exec, block, 3>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 4:
                        compute_internal<Circ_exec, block, 4>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 5:
                        compute_internal<Circ_exec, block, 5>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 6:
                        compute_internal<Circ_exec, block, 6>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 7:
                        compute_internal<Circ_exec, block, 7>(out_window, in_window, leftover, rep_exec);
                        break;
                    case 8:
                        compute_internal<Circ_exec, block, 8>(out_window, in_window, leftover, rep_exec);
                        break;
                    default:
