...
namespace emp
{
    ...
    class rep_array_unsliced
    {
        ...
        template <typename S>
        friend class rep_array_unsliced;
        template <typename S, int slice_sz_Ss>
        friend class rep_array_sliced;
    ...
    public:
        void get_share(int party, T *secrets)
        {
            if (party == 1)
            {
        ...
        template <typename S>
        void copy(rep_array_unsliced<S> &src)
        {
        ...
        template <typename S>
        void copy_one(uint dst_index, rep_array_unsliced<S> &src, uint src_index = 0)
        {
        ...
        template <typename S>
        void copy_bytes_from(rep_array_unsliced<S> &src, uint64_t num_bytes,
